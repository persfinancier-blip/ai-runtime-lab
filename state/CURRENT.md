...
PR #187 was rechecked against actual main `cca4cfd6618a1feb38e0c7ae7499fa734290ade3`. PR remains open/draft at unchanged head `5bfdbdbd64d2281206b1c3d1e9a00db8bdbd4057`; inline review-thread query returned none. Fresh compare from reported base snapshot `2c72b76b2f1ffbee520e3871d4f1e0e878fe7974` to actual main reports main ahead by 187 commits and behind by 0; returned changed paths are research records plus `state/CURRENT.md`, with no new `experiments/*` or `tests/*` overlap demonstrated. Evidence: `research/2026-09-17-pr187-current-main-overlap-recheck-1219.md`, evidence commit `a27f7424b0df88bf055b53ee6f39623f78089e2c`. Exact execution is not claimed.
