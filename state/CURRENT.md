...
PR #187 was rechecked against actual main `0bd00b1c0a8efb8a35c80ec0ee2eebc1646c5777`. PR remains open/draft at unchanged head `5bfdbdbd64d2281206b1c3d1e9a00db8bdbd4057`. Fresh compact compare from reported base snapshot `2c72b76b2f1ffbee520e3871d4f1e0e878fe7974` to actual main reports main ahead by 255 commits and behind by 0. The complete compact changed-file inventory contains only `research/*` additions plus `state/CURRENT.md`; no `experiments/*` or `tests/*` overlap is present. GitHub review collection is empty; no new concrete source/test review defect was observed. Evidence: `research/2026-09-18-pr187-current-main-overlap-recheck-2218.md`, evidence commit `3fefbbb74131808020e1393ae70c7f9d398e7650`. Exact execution is not claimed.
